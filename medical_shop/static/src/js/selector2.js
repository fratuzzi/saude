...
function highlight(id)
{
    ...
    if(bodyPart != null)
    {
        ...
        if(id>0)
        {
            trHeight = posTr[1] - findPos(document.getElementById('BodyPartTable').rows[id-1])[1];
        }
        else
        {
            trHeight = findPos(document.getElementById('BodyPartTable').rows[1])[1] - posTr[1];
        }
        ...
        else
        {
            ...
            if(id==0)      { y1-=(144*hRel)/317; }
            else if(id==1) { y1-=(140*hRel)/317; }
            else if(id==2) { y1-=(127*hRel)/317; }
            else if(id==3) { y1-=(88*hRel)/317; }
            else if(id==4) { y1-=(70*hRel)/317; x1+=(35*wRel)/126; }
            else if(id==5) { y1-=(35*hRel)/317; }
            else if(id==6) { y1+=(58*hRel)/317; x1+=(15*wRel)/126; }
            else if(id==7) { y1-=(25*hRel)/317; x1+=(35*wRel)/126; }
        }
